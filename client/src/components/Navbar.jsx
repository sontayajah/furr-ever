  ...
  return (
    <nav className="py-4 px-8 flex items-center justify-between">
      ...
      <div className="flex gap-4 items-center">
        ...
        <Link to="#" className="font-bold px-4 py-2 bg-orange-600 text-white rounded-md active:bg-white active:text-orange-600 active:ring-1 active:ring-orange-600">Create account</Link>
      </div>
    </nav>
  )
}
